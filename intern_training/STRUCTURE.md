...
This document provides a high-level overview of the 6-week fundamentals-first Django intern training program with 127 curated problems.
...
- **Focus**: Arrays, hashmaps, stacks, queues; sorting, searching; two pointers, sliding window; **comprehensive tree/BST coverage**; graphs basics; time/space complexity
- **Problems**: 30-40 from ProblemBank_DSA.md (47 total: arrays, stacks, queues, **16 tree/BST problems**, sorting, searching, patterns, graphs)
- **Milestone**: Algorithm implementations with tests and complexity analysis; tree traversals (recursive + iterative); BST operations
- **Gate**: 30+ DSA problems solved; complexity documented; pattern mastery demonstrated; all tree traversals implemented
...
**Total: 115-145 curated problems with tests and documentation from 127 available problems**
...
- `ProblemBank_DSA.md`: **47 problems** (Week 3) - Arrays, stacks, queues, **16 tree/BST problems**, sorting, searching, patterns, graphs
