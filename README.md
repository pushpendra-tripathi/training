...
- **Testing mindset**: pytest mastery; write unit/integration tests for core logic; TDD awareness; test coverage understanding
...
- **Team integration**: Git branching strategies, PR etiquette, code review participation, readable commits, comprehensive documentation
...
### Daily detail
Use the per‑day plans under `intern_training/weekXX/` for granular tasks. Note: Week 3 (DSA) and Week 6 (Django Advanced) materials are being created and will map to existing day files with updated focus.
...
### Problem banks (125+ curated problems)
...
- **[ProblemBank_DSA.md](intern_training/ProblemBank_DSA.md)**: 47 problems (arrays, stacks, queues, **comprehensive tree/BST coverage**, sorting, searching, two-pointers, sliding window, graphs)
...
**Total: 127 problems** with sample inputs/outputs and complexity guidance.

**Note**: Legacy problem banks (ProblemBank_A, ProblemBank_B) have been deprecated and moved to `intern_training/legacy/`.
